"""
Django settings for split_auth project.
...
SECRET_KEY = '@x2k&))yy%^4*h5#c0yxr%itb42wum$89gtelwdjxy)+df22cx'
...
WSGI_APPLICATION = 'split_auth.wsgi.application'
